...
public sealed partial class NoteNodeView : UserControl, INodeView
{
    ...
    /// above 3.7, which is what made the note stop matching its own box. The header paints at
    /// <see cref="Camera.ChromeScale"/>: proportional below 1×, clamped at device size above.
    /// </summary>
